        ...
        <header className="w-full border-b border-divider">
            <div className="hidden md:flex items-center justify-between px-8 py-4 bg-header">
                <div className="flex items-center  flex-row gap-4">
                    ...
                    <svg
                        ...
                        fill="currentColor"
                    >
                        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 
            ...
            <div className="flex items-center justify-center px-4 py-3 md:px-8 bg-white">
                <div className="flex items-center gap-4">
                    <button onClick={() => setShowExtraNav(!showExtraNav)} className="md:hidden">
                ...
                <div className="hidden md:flex items-center gap-6">
                    ...
                    <a href="/shelters" className="text-sm font-medium hover:text-primary">
                        Shelters & Rescues
                    </a>
            ...
            {showExtraNav && (
                <div className="md:hidden bg-header-extra border-t border-divider">
                    <nav className="flex flex-col p-4 gap-3">
                        <a href="/dogs" className="text-sm font-medium text-gray-700 hover:text-primary">
                        Dogs
                        </a>
                        <a href="/cats" className="text-sm font-medium text-gray-700 hover:text-primary">
                        Cats
                        </a>
                        <a href="/shelters" className="text-sm font-medium text-gray-700 hover:text-primary">
                        Shelters & Rescues
                        </a>
                        <a href="/resources" className="text-sm font-medium text-gray-700 hover:text-primary">
                        Resources
                        </a>
                    </nav>
                </div>
